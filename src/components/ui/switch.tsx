  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block rounded-full ring-0 transition-transform translate-x-0 data-[size=default]:h-4 data-[size=default]:w-4 data-[size=sm]:h-3 data-[size=sm]:w-3 group-data-[size=default]/switch:data-checked:translate-x-[calc(100%-2px)] group-data-[size=sm]/switch:data-checked:translate-x-[calc(100%-2px)] data-checked:bg-primary-600 data-unchecked:bg-gray-400"
      />
    </SwitchPrimitive.Root>
  )
}
